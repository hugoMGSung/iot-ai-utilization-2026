...
- ChatGPT 같은 대규모 언어 모델(LLM)을 개인 PC나 서버 등 로컬 환경에서 무료로 쉽게 설치하고 실행할 수 있도록 도와주는 오픈소스 플랫폼
...
- GPU 성능에 영향을 받음
- LLM : 숫자b - 숫자가 크면 클수록 모델용량 큼. 그래픽카드 성능도 좋아야 함
...
3. 코딩에 포커스를 맞춘 Ollama 모델 풀받기
    - qwen2.5-coder:7b

4. VS Code에 continue 확장을 설치

    ![alt text](image-20.png)

5. continue 기본화면. continue.dev 사이트 회원가입

    ![alt text](image-21.png)

6. ChatGPT, ClaudeCode, Gemini 가입플랜 연동 화면

    ![alt text](image-22.png)

7. Local 연결화면(우리가 사용할 탭)
...
9. Download Chat model 터미널 복사 클릭, 실행
